...
const IndustriesPage = () => {
  ...
  const heroImages = [
    ...
    "https://images.unsplash.com/photo-1565439396656-e4ef6595a8bf?q=80&w=2670&auto=format&fit=crop", // Machinery
    "https://images.unsplash.com/photo-1537462713205-e513d5509d36?q=80&w=2670&auto=format&fit=crop", // Modern Production
    "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?q=80&w=2669&auto=format&fit=crop"  // Engineering/Processing
  ];
      ...
      <div className="container mx-auto px-4 py-20 max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row gap-12 mb-32 items-center">
          ...
          <div className="w-full md:w-1/2 md:pl-8">
            ...
            <Button
              onClick={() => navigate("/industries/shanti-agro")}
          ...
          <div className="w-full md:w-1/2 md:pr-8 text-right md:text-left">
            ...
            */}
            ...
            <div className="flex justify-start">
              <Button
                onClick={() => navigate("/industries/vinod-rice-mill")}
                className="bg-[#0f2c4a] hover:bg-[#0a1f35] text-white rounded-none px-8 py-6 text-sm tracking-widest uppercase font-semibold transition-all group"
              >
                Visit Page
                <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
