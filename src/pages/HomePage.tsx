import { ArrowRight, Leaf, Building2, Pill, Cpu, Cog, Star, Award, Users, Heart, Globe, Calendar, Trophy, Target, Home } from "lucide-react";
      ...
      <section className="section-padding bg-gradient-to-br from-primary/10 via-background to-secondary/10 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
              Upcoming <span className="text-gradient">Project</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Discover our newest development that's set to redefine modern living
            </p>
          </div>

          <Link to="/real-estate" className="block max-w-4xl mx-auto group">
            <Card className="card-premium overflow-hidden hover:shadow-2xl transition-all duration-500 cursor-pointer group-hover:scale-[1.02] border-2 border-primary/20 hover:border-primary/40">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      <h3 className="text-3xl md:text-4xl font-bold text-white">Awadh Nagari</h3>
                      <p className="text-white/80 font-medium">A Township of Dreams • Gondpipari</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 bg-white/20 px-6 py-3 rounded-full group-hover:bg-white/30 transition-colors">
              ...
              <CardContent className="p-8">
                <div className="grid md:grid-cols-3 gap-6 text-center">
                  <div className="p-4 bg-muted/30 rounded-xl">
                    ...
                    <h4 className="font-semibold text-foreground">Premium Homes</h4>
                    <p className="text-sm text-muted-foreground">2, 3 & 4 BHK Options</p>
                  </div>
                  <div className="p-4 bg-muted/30 rounded-xl">
                    <Leaf className="h-8 w-8 text-primary mx-auto mb-3" />
                    <h4 className="font-semibold text-foreground">Green Living</h4>
                    <p className="text-sm text-muted-foreground">Eco-friendly Design</p>
                  </div>
                  <div className="p-4 bg-muted/30 rounded-xl">
                    <Calendar className="h-8 w-8 text-primary mx-auto mb-3" />
                    <h4 className="font-semibold text-foreground">Launch 2025</h4>
